...
# MULTICHAIN END
        ...
        if tx is None:
            body += ['<p class="error">Transaction not found. If you have recently submitted the transaction, please wait for 15 seconds or more.</p><div class="loader"></div><script type="text/javascript">setTimeout( function(){ location.reload(); },15000)</script>']
            return
...
# MULTICHAIN END
    ...
    def show_search_results(abe, page, found):
        if not found:
            page['body'] = [
                '<p>No results found. If you have recently submitted the transaction, please wait for 15 seconds or more. </p><a href="javascript:window.location.reload(true)">REFRESH</a>\n', abe.search_form(page)]
            return
